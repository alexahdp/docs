...
Tags are essential for further categorizing questions by topic. For instance, you can tag some test questions as Algebra and others as Geometry. Once the test is completed, you will have access to additional statistics that reveal the user's proficiency in each section. For example, you may find that the user excels in the Algebra section but struggles with Geometry, or vice versa. It's worth noting that you can assign multiple tags to each question, which will enhance the structure and organization of your test results.
...
**_Be careful if you are going to change parts of your test URL, including your first and last name in your account settings. After changing the URL, the test will not be available at the previous URL._**
