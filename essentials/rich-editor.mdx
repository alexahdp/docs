...
To start using this, click on any of the fields above.
When you activate the input, you will see a “Plus” icon on the left, when you click on it you will see the rich editor menu.
The second way to bring up the menu is to enter the symbol `/`.
...
You can use all these options only in the fields for entering the test description and question description. For the question and answer options, you can use a limited set of rich editor capabilities that omit header options.
